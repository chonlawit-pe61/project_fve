...
?>
        <table style="width: 100%; margin-bottom: 10px;">
            <tr>
                <td style="text-align: center; font-size: 18px;">
                    <h5>
                        <b style="font-size: 18px;">แบบบันทึกผลการเรียนและประเมินผล</b>
                    </h5>
                </td>
            ...
            <tr>
                <td style="text-align: center;">
                    <h5>
                        <b style="font-size: 18px;">วิทยาลัยการอาชีพฝาง สำนักงานคณะกรรมการการอาชีวศึกษา กระทรวงศึกษาธิการ</b>
                    </h5>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;">
                    <h5>
                        <b style="font-size: 18px;">ภาคเรียนที่ <?php echo $_GET['term'] ?> ปีการศึกษา <?php echo $_GET['year'] + 543 ?></b>
                    </h5>
                </td>
            </tr>
        ...
        <table style="width: 100%; text-align: center; margin-bottom: 12px;">
            <tr>
                ...
                <td class="dot" style="text-align: start;">
                    <?php echo $row['details']['subjects_id'] ?>
                </td>
                <td style="width: 6%;">
                    ชื่อวิชา
                </td>
        ...
        <table style="width: 100%; margin-bottom: 10px;">
            <tr>
                ...
                <td class="dot" style="text-align: center;">
                    <?php echo $row['graduated_level']['certificate_name'] ?>
                </td>
                <td style="width: 8%;">
                    แผนกวิชา
                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_4 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                                            if ($sum_4 >= 80) {
                                                $idx_4++;
                                            }
                                        }
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_3_5 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_3 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_2_5 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_2 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_1_5 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_1 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    foreach ($row as $key => $student) {
                                        if (is_array($student) && isset($student['affective'])) {
                                            $sum_0 += floatval($student['affective']) + floatval($student['test']) + floatval($student['work']) + floatval($student['final_exam']) + floatval($student['midterm_exam']);
                                            if (@$sum_0 <= 50) {
                                                $idx_0++;
                                            }
                                        }
        ...
        <div>
            ...
            <div class="row" style="margin: 0; padding: 0;">
                ...
                <div class="column-1 " style="margin: 0; padding: 0;text-align: left;">
                    <?php echo $row['std_level']['education_year_name'] ?>
                </div>
                <div class="column-2" style="margin: 0; padding: 0;">
                    แผนกวิชา <?php echo $row['department_name'] ?>
                </div>
                <div class="column-6" style="margin: 0; padding: 0;">
                    <?php
                    $h = ($row['details']['hour'] * 18);
                    $result_h = ($h) * (80 / 100)
                    ?>
                    เวลาเรียนเต็ม <?php echo $h ?> ชั่วโมง เวลาเรียนร้อยละ 80 เท่ากับ <?php echo $result_h ?> ชั่วโมง
                </div>
            </div>
            <div class="row" style="margin: 0; padding: 0;">
                <div class="column-1" style="margin: 0; padding: 0;">
        ...
        <table border="1" style="width: 100%; vertical-align: middle;border-collapse: collapse; font-size: 16px;">
            ...
            foreach ($row as $key => $student) {
                $indexRow++;
                if (!is_array($student)) {
                    continue; // ข้ามถ้าไม่ใช่นักเรียน
                }
            ?>
                <tr>
                    <td style="text-align: center;">

                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="d-flex justify-content-center ">
                        <div class="col-12 col-xl-9">
                            <img class="img-fluid rounded" loading="lazy" src="<?php echo base_url('public/img/backgroudLogo.png') ?>" width="350" height="10" alt="BootstrapBrain Logo">
                            <hr class="border-primary-subtle mt-1 mb-4 hr  " style="color: white;">
                            ...
                            <p class="lead mt-1 mb-5 text-white">ส่งเสริมนักศึกษา สร้างการเรียนรู้ สรรค์สร้างนวัตกรรมใหม่.</p>
                            <h2 class="h1 mb-0 text-white">โปรแกรม Pre-Ved FVE</h2>
                            <p class="lead mt-1 mb-0 text-white">พัฒนาโดย นายนฤเบศ สอนง่าย เเละ นายวชิรวิทย์ โปธิตา</p>
                            <p class="lead text-white">ครูประจำสาขาวิชาเทคโนโลยีธุรกิจดิจิทัล</p>
